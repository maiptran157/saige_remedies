                ...
                <div onLoad={this.modalCheck} className="basic-modal" onClick={this.close}>
                    <div onClick={e => e.stopPropagation()} className="basic-modal-content">
                        ...
                        <p>
                            ...
                            None of the posts and articles on SaigeRemedies.com may be re-printed without express written permission of the author. Saige Remedies will respond to written requests to re-print parts of posts and excerpts/quotes (10% or less) may be reprinted with attribution as long as all links are left intact.
                        </p>
