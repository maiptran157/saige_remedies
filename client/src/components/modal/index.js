            ...
            return (
                <div onLoad={this.modalCheck} className="basic-modal" onClick={this.close}>
                    <div onClick={e => e.stopPropagation()} className="basic-modal-content">
                        ...
                        <h1>Disclaimer</h1>
                        <p>Please read the following disclaimer carefully before using this website.
                        See also the official Saige Remedies® Terms of Service, Privacy Policy, and Affiliate Disclosure.
...
SaigeRemedies.com reserves the right to remove, edit, move or close any content item for any reason, including, but not limited to, comments that are in violation of the laws and regulations formed pursuant to the Federal Food, Drug and Cosmetic Act.
None of the posts and articles on SaigeRemedies.com may be re-printed without express written permission of the author. Saige Remedies will respond to written requests to re-print parts of posts and excerpts/quotes (10% or less) may be reprinted with attribution as long as all links are left intact.</p>
